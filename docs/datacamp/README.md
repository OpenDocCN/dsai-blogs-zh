...
> 原文：[DataCamp Blog](https://www.datacamp.com/blog)
> 
...
* [在线阅读](https://dtcm.flygon.net)
## 下载

### Docker

```
docker pull apachecn0/datacamp-blog-zh
docker run -tid -p <port>:80 apachecn0/datacamp-blog-zh
...
```
npm install -g datacamp-blog-zh
datacamp-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
